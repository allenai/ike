...
libraryDependencies ++= Seq(
    ...
    allenAiTestkit,
    allenAiDatastore,
    nlpstackModule("tokenize") excludeAll(ExclusionRule(organization = "com.amazonaws")),
    nlpstackModule("postag") excludeAll(ExclusionRule(organization = "com.amazonaws")),
    nlpstackModule("chunk") excludeAll(ExclusionRule(organization = "com.amazonaws")),
    nlpstackModule("lemmatize") excludeAll(ExclusionRule(organization = "com.amazonaws")),
    nlpstackModule("segment") excludeAll(ExclusionRule(organization = "com.amazonaws")),
    lucene("core"),
