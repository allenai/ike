...
class TestOpConjunctionOfDisjunctions extends UnitSpec {
  ...
  val suffix1 = EvaluatedOp.fromPairs(SetToken(Suffix(1), QWord("s1")),
    List((1,1), (2,0), (3,0), (4,1), (5,1), (6,1)))
  val prefix21 = EvaluatedOp.fromPairs(SetToken(Prefix(2), QWord("p21")),
    List((1,1), (2,1), (8,0)))
  val prefix22 = EvaluatedOp.fromPairs(SetToken(Prefix(2), QWord("p22")),
    List((1,1), (3,0), (4,1), (9,1)))
  val replace3 = EvaluatedOp.fromList(SetToken(Match(3), QCluster("r3")),
    List(1, 2, 3, 4, 5, 6, 7))
  val add3 = EvaluatedOp.fromPairs(AddToken(3, QWord("a3")),
    List((3,1), (4,0), (5,0)))
